...
class _SignInUserPageState extends State<SignInUserPage> with SingleTickerProviderStateMixin {
  ...
  void _submit() async {
    ...
    try {
      ...
      await PreferencesService.instance.saveRemembered(
        ...
        role: _remember ? 'FREELANCER' : null,
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SignInShell(
        title: 'GigMeWork',
        subtitle: 'Find gigs, grow your career',
        child: AnimatedBuilder(
          animation: _shakeCtl,
          builder: (context, child) {
            final dx = _shakeCtl.isAnimating
                ? (1 - _shakeAnim.value) * 14 * (_shakeAnim.value % 0.2 > 0.1 ? -1 : 1)
                : 0;
            ...
            child: Column(
              ...
              children: [
                TextFormField(
                  ...
                  onChanged: (_) {
                    if (_authError != null || _emailAuthError != null) {
                      setState(() { _authError = null; _emailAuthError = null; });
                    }
                  },
                ),
